...
export default function ArticleContent({ article }: ArticleContentProps) {
  ...
  const articleContent = (
    <article className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-4 sm:p-6 lg:p-8 mb-8 lg:mb-12 text-center md:text-left">
      {/* Image de l'article */}
      {article.imageUrl && (
        <div className="relative h-48 sm:h-64 lg:h-80 xl:h-96 rounded-xl overflow-hidden mb-6 lg:mb-8">
          <Image 
      ...
      {/* Métadonnées */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 text-sm text-gray-400 space-y-2 sm:space-y-0">
      ...
      {/* Titre */}
      <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-6 font-winky leading-tight">
        {article.title}
      </h1>
